...
#TODO: drop antennaArray, only (lat,lon,elev) is used from this file, but it is non-trivial to convert (x,y,z) which is in the antennaField file to (lat,long,elev)
